 ...
 */
 ...
 const famousPerson: string = "Allama Iqbal";

 const quote = `${famousPerson} once said, "Allama Iqbal once said, "Failure is not fatal until we 
 surrender trying again is the key to glorious victory."`;
