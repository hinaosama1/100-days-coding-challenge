...
var current_users = ["hooria", "osama", "asiya", "sughra", "ayesha", "mahnoor"];
var new_users = ["dilshad", "haider", "hassan", "ayesha", "mahnoor"];
...
new_users.forEach(function (new_user) {
    ...
    var userNameTaken = current_users.some(function (current_user) { return current_user.
